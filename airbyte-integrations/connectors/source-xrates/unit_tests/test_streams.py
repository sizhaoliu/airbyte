...
import pytest
from source_xrates.source import XratesStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(XratesStream, "path", "v0/example_endpoint")
    mocker.patch.object(XratesStream, "primary_key", "test_primary_key")
    mocker.patch.object(XratesStream, "__abstractmethods__", set())
